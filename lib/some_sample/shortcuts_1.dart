          ...
          body: Center(
            child: Row(
              children: <Widget>[
                const Spacer(),
                Expanded(
                  child: TextField(focusNode: fc, controller: controller),
                ),
                IconButton(
...
class CopyAction extends Action<CopyIntent> {
  ...
  Object? invoke(covariant CopyIntent intent) {
    ...
    final String selectedString = controller.text.substring(begin, end);
